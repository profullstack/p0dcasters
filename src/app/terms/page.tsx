    ...
    <div className="wrap">
      <section className="prose">
        ...
        <p>
          ...
          show arrives from the Podcast Index on its own or is{" "}
          <Link href="/submit">added</Link> by its publisher and listed after a person has
          looked at it — nobody is paid to be included and nothing is sold. By submitting a
          feed you confirm you may share its address; a listed submission is passed to
