 ...
 * creative and still counts as an impression nobody could have looked at. It
 * costs the advertiser a view and drags the slot's click rate down with it.
 *
...
export default function AdBanner({ className = "" }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // being squeezed under .wrap's max-width and clipping its own creative.
  ...
  return (
    <div ref={ref} data-cp-ad="" className={`ad ad-banner${className ? ` ${className}` : ""}`} />
  );
}
